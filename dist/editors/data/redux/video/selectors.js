...
const getTranscriptDownloadUrl = exports.getTranscriptDownloadUrl = (0, _reselect.createSelector)([AppSelectors.simpleSelectors.studioEndpointUrl, AppSelectors.simpleSelectors.blockId], (studioEndpointUrl, blockId) => ({
  language
}) => (0, _urls.downloadVideoTranscriptURL)({
  studioEndpointUrl,
  blockId,
  language
}));
const buildTranscriptUrl = exports.buildTranscriptUrl = (0, _reselect.createSelector)([AppSelectors.simpleSelectors.studioEndpointUrl], studioEndpointUrl => ({
  transcriptUrl
}) => (0, _urls.mediaTranscriptURL)({
  studioEndpointUrl,
  transcriptUrl
}));
const getHandoutDownloadUrl = exports.getHandoutDownloadUrl = (0, _reselect.createSelector)([AppSelectors.simpleSelectors.studioEndpointUrl], studioEndpointUrl => ({
  handout
}) => (0, _urls.downloadVideoHandoutUrl)({
  studioEndpointUrl,
  handout
}));
